      ...
      <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="step-first" data-wizard-clickable="false">
        ...
        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
          <div class="col-xl-12 col-xxl-7">
            <!--begin::Wizard Form-->
            <form class="form" id="kt_foram" action="{{ route('petugas.store') }}" method="POST">
              @csrf
              <!--begin::Wizard Step 1-->
              <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                <h3 class="mb-10 font-weight-bold text-dark">Create Data Petugas</h3>
                <!--begin::Input-->
                <div class="form-group">
                  <label>Nama Petugas</label>
                  <input type="text" class="form-control form-control-solid form-control-lg" name="nama_petugas" placeholder="Nama Petugas" autofocus/>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control form-control-solid form-control-lg" name="telp" placeholder="No Telepon" />
                  <span class="form-text text-muted"></span>
                </div>
                <!--end::Input-->
                <!--begin::Input-->
