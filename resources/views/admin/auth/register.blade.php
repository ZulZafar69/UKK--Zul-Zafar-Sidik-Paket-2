						...
						<div class="login-signin">
							...
							<form  id="kt_login_signup_form">
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="nama" name="nama_petugas" />
								</div>
								<div class="form-group mb-5">
								...
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="number" placeholder="telp" name="telp" />
								</div>
							...
							<div class="mt-10">
								...
								<a href="{{ route('admin.login') }}" id="kt_login_signup" class="text-muted text-hover-primary font-weight-bold">Sign In!</a>
							</div>
						</div>
