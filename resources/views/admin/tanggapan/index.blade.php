...
@section('title', 'Data Pengaduan Masyarakat Cisarua')
@section('route', 'Data Pengaduan Masyarakat Cetak PDF')
              ...
              <div class="card card-custom gutter-b">
                  <div class="card-header flex-wrap py-3">
                      <div class="card-title">
                          <h3 class="card-label">List Data Pengaduan
                          ...
                          <tbody>
                              @foreach ($datas as $item)
                                      <tr>
                                          ...
                                          <td>
                                            @if ($item->status == '0')
                                            <span class="badge bg-danger"><i class="bi bi-collection me-1"></i>{{ ($item->status == 0) ? 'Belum Di Proses' : ''  }}</span>
                                            @endif     
                                            @if ($item->status == 'proses')
                                            <span class="badge bg-info"><i class="bi bi-star me-1"></i>{{ ($item->status == 'proses') ? 'Proses' : ''  }}</span>
                                            @endif          
                                            @if ($item->status == 'selesai')
                                            <span class="badge bg-success"><i class="bi bi-check-circle me-1"></i>{{ ($item->status == 'selesai') ? 'Selesai' : ''  }}</span>
                                            @endif   
                                          </td>
                                          <td>
                                              <div class="btn-group">
