			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                      ...
                      <li class="menu-item" aria-haspopup="true">
												<a href="{{ route('list-pengaduan') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text">List Pengaduan</span>
													<span class="menu-label">
														{{-- <span class="label label-danger label-inline">new</span> --}}
													</span>
												</a>
							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Rakyat</span>
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Login or Register</span>
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				<h3 class="font-weight-bold m-0">User Profile</h3>
                    @auth
                    <small class="text-muted font-size-sm ml-2">Nik Anda {{Auth::user()->nik}}</small>
                    @endauth
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
                            ...
                            <a href="{{route('register')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Register</a>
                            @endguest
		...
		<div id="kt_quick_cart" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
				...
				<a href="#" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_cart_close">
					<i class="ki ki-close icon-user text-muted"></i>
				</a>
			</div>
			<!--end::Header-->
			<!--begin::Content-->
